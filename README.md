...
The current build is a complete local vertical slice: choose a home borough, trade twelve products over thirty days, revisit evolving borough markets, use the bank and loan shark at home, manage debt, heat, health, capacity, and a raw gun count, survive police encounters, and finish with discounted Day 30 liquidation. Runs save automatically in the browser and completed scores remain on that device.
...
- `src/test/` covers replay, accounting, unlimited market depth, borough continuity, financing, guns, Day 30 settlement, availability, multi-seed invariants, save/resume, and personal-score retention.
